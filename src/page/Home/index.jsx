...
const data = [
  {
    icon: "https://glo365.vn/wp-content/uploads/2021/06/SkinGym-Round.png",
    title: "P+ LASER",
    conten:
      "Mô hình luyện tập nâng cao sức khỏe làn da. Giải quyết triệt để và an toàn mọi vấn đề trên bề mặt da chỉ 20 phút mỗi tuần.",
  },
  {
    icon: "https://glo365.vn/wp-content/uploads/2021/06/DreamSculpt-Round.png",
    title: "BODY CONTOUR",
    conten:
      "Phương pháp duy trì đường nét cơ thể bằng sóng vô tuyến điện dung thông minh. Giúp săn chắc da và đảo thải mỡ thừa.",
  },
  {
    icon: "https://glo365.vn/wp-content/uploads/2021/06/FaceGym-men-Round.png",
    title: "FACE GYM",
    conten:
      "Liệu trình duy trì đường nét V-line. Độ săn chắc và trẻ hóa gương mặt được thực hiện hàng tuần một cách khoa học và đều đặn.",
  },
];
const slider = [
  {
    id: 1,
    image:
      "https://glo365.vn/wp-content/uploads/2019/11/all-about-hair-big.svg",
  ...
  },
  {
    id: 5,
    image:
      "https://glo365.vn/wp-content/uploads/2019/11/skin-Revolution-Big.svg",
  ...
  },
  {
    id: 6,
    image:
      "https://glo365.vn/wp-content/uploads/2019/11/walk-in-glow-out-big.svg",
...
const dataDB = [
  {
    icon: "https://glo365.vn/wp-content/themes/ndg-quantum/imgs/earth-globe.svg",
    title: "PHÒNG KHÁM Q.2",
    conten: "63 Xuân Thủy, Quận 2, Thành phố Thủ Đức",
  },
  {
    icon: "https://glo365.vn/wp-content/themes/ndg-quantum/imgs/phone-symbol-of-an-auricular-inside-a-circle.svg",
    title: "Hotline",
    conten: "1800 6733",
  },
  {
    icon: "https://glo365.vn/wp-content/themes/ndg-quantum/imgs/earth-globe.svg",
    title: "PHÒNG KHÁM FLAGSHIP Q.1",
    conten: "31A Lý Tự Trọng, Quận 1, Thành phố Hồ Chí Minh.",
  },
];
  ...
  return (
    <div className="container min-w-full h-auto relative">
      ...
      <div className="relative z-10">
        <div
          className={`position m-auto mb-40 w-full m-auto h-${slidesToShows}`}
        >
      ...
      <div className="mt-10">
        ...
        <div className=" h-auto flex justify-center items-center grid xl:grid-cols-3 mb-20 xl:flex-row sm:flex-col flex-col">
          {data.map((datax, i) => (
            <div
              key={i}
              className=" h-auto flex flex-col items-center m-auto mb-10"
            >
              ...
              <p
                style={{ fontFamily: "Comfortaa, Arial" }}
                className="text-justify leading-7 w-[65%] font-medium"
              >
                {" "}
                {datax.conten}
              </p>
      ...
      <div className="flex flex-col  items-center my-20">
        <img
          className="m-auto w-[5%] mb-10"
          src="https://glo365.vn/wp-content/uploads/2019/09/gift.svg"
          alt="ảnh"
        />
        <h2 className="text-4xl leading-6 font-extralight ">
          ĐẸP NGAY CHỜ CHI!
        </h2>
        <p className="w-3/4 leading-8 text-center my-10">
          Đặt hẹn phân tích da với bác sĩ. Toả sáng ngay cùng kế hoạch làm đẹp
          cho riêng bạn!
        </p>
        <form onSubmit={handleFormSubmit}>
          <div
            className={`px-5 mx-5 h-auto flex justify-center items-center grid grid-cols-${inputShow} mt-3`}
          >
            <div className="px-5 mx-5 border-b-2 border-rose-400 grid grid-cols-1 mt-3">
              <input
                ...
                name="name"
                id="name"
                className="bg-transparent text-xl border-transparent p-3 text-center outline-none"
                placeholder="Tên"
              />
            </div>
            <div className="px-5 mx-5 border-b-2 border-rose-400 grid grid-cols-1 mt-3">
      ...
      <img
        className="mt-10"
        src="https://glo365.vn/wp-content/uploads/2019/09/line-01.svg"
        alt="ảnh"
      />
      <div className="flex flex-col  items-center my-20">
        <h2 className="text-4xl leading-6 font-extralight "> VỀ CHÚNG TÔI</h2>
        <p style={{ zIndex: 10 }} className="w-3/4 leading-8 text-center my-10">
          Glo365 là một Beauty Concept đẳng cấp 5 sao hàng đầu Châu Á, bao gồm
          các dịch vụ thẩm mỹ và làm đẹp cao cấp nhằm nâng cao trải nghiệm khách
          hàng vượt khỏi lằn ranh của giới hạn. Tại Việt Nam, Glo365 đang khẳng
          định vị thế tiên phong với các dịch vụ thẩm mỹ công nghệ đỉnh cao được
          FDA chứng nhận.
        </p>
        <div
          style={{ zIndex: 10 }}
      ...
      <div className="position">
        <div className="w-full m-auto h-96">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3916.7827134163545!2d106.66742300000001!3d10.979767!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174d735e1167645%3A0x624d4798123de4d1!2zNDI5IMSQ4bqhaSBs4buZIELDrG5oIETGsMahbmcsIFBow7ogQ8aw4budbmcsIFRo4bunIEThuqd1IE3hu5l0LCBCw6xuaCBExrDGoW5nLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2sus!4v1698249156874!5m2!1svi!2sus"
            // width={800}
            height={770}
            style={{ border: 0 }}
            className="w-full"
